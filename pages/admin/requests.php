...
<body class="layout-boxed">
    ...
    <div class="main-container" id="container">
        ...
        <div id="content" class="main-content">
            <div class="layout-px-spacing">
                                                                    ...
                                                                    if ($result && $result->num_rows > 0) {
                                                                        while ($requestee = $result->fetch_assoc()) {
                                                                            ...
                                                                            $html .= '<td class="d-flex justify-content-evenly">
                                                                                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#deactivateModal" data-id='.htmlspecialchars($requestee['user_id']).' data-reqid='.htmlspecialchars($requestee['request_code']).' data-doc='.htmlspecialchars($requestee['request_docu']).' data-pur="'.$requestee["purpose"].'">Create</button>
                                                                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id='.htmlspecialchars($requestee['request_code']).'>Reject</button>
                                                                                    </td>';
                                                                            $html .= '</tr>';
                                                                        }
                                                                        echo $html;
                                                                ...
                                                                <?php
                                                                    ...
                                                                    if ($result && $result->num_rows > 0) {
                                                                        while ($requestee = $result->fetch_assoc()) {
                                                                            ...
                                                                            $html .= '<td class=""><span class=" w-100 bs-tooltip badge '. (($requestee['status'] == 'RELEASED') ? 'badge-success' : 'badge-warning') .' data-bs-toggle="tooltip" data-bs-placement="top" title="Request on Pending" mb-2 me-4">' . htmlspecialchars($requestee['status']) . '</span></td>';
                                                                            $html .= '<td class="d-flex justify-content-evenly">
                                                                                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="' . ($requestee['request_docu'] == 'Clearance' ? '#clearanceModal' : '#deactivateModal') . '" data-id="' . htmlspecialchars($requestee['user_id']) . '" data-reqid="' . htmlspecialchars($requestee['request_code']) . '" data-doc="' . htmlspecialchars($requestee['request_docu']) . '" data-pur="' . htmlspecialchars($requestee["purpose"]) . '">Create</button>
                                                                                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="' . htmlspecialchars($requestee['request_code']) . '">Reject</button>
                                                                                    </td>';
                                                                            $html .= '</tr>';
                                                                        }
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h6 class="modal-title" id="exampleModalCenterTitle"><b>Generate Document</b></h6>
                                ...
                                <div class="modal-body">
                                    <div>
                                        <p>Generate Document for Request <b><i id="reqCode"></i></b></p><br>
                                        <form id="generateDoc">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-success" id="submitGenerate">Generate</button>
                ...
                <!-- generate modal end -->
                <!-- clearance modal start -->
                <div class="modal fade" id="clearanceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h6 class="modal-title" id="exampleModalCenterTitle"><b>Generate Document</b></h6>
                                ...
                                <div class="modal-body">
                                    <div>
                                        ...
                                        <form id="generateClearance">
                                            <p>Generate Document for Request <b><i id="reqCode2"></i></b></p><br>
                                            <input class="form-control mb-4" name="cedula" placeholder="CTC Number">
                                            <select name="recordz" id="recordz" class="form-select">
                                                <option value="" selected disabled>--Choose Record--</option>
                                                <option value="NO DEROGATORY RECORD">NO DEROGATORY RECORD</option>
                                                <option value="RECORD">SAMPLE OPTION</option>
                                            </select>
                                            <input type="hidden" name="user_id" id="user_id2">
                                            <input type="hidden" name="req_id" id="req_id2">
                                            <input type="hidden" name="docu" id="docu2">
                                            <input type="hidden" name="pur" id="pur2">
                                        </form>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-success" id="submitClearance">Generate</button>
                                        <button class="btn btn-light-dark" data-bs-dismiss="modal">Cancel</button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div>
                                    <p>Reject Requests <b><i id="reqCode33"></i></b> ?</p><br>
                                </div>
                                <form id="cancelRequest">
                                    <input type="hidden" name="id" id="student_id">
                                    <div class="modal-footer">
                                        <button type="submit" id="cancelReq" class="btn btn-danger">Reject</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const cancelRequestForm = document.getElementById('cancelRequest');
            const cancelRequest = document.getElementById('cancelDeleteStudent');

            cancelRequestForm.addEventListener('submit', function(event) {
                event.preventDefault();

                const formData = new FormData(cancelRequestForm);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('generateDoc').addEventListener('submit', function(event) {
                event.preventDefault();
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        generateExcel(data.newFileName, ctrl, datetodz, requestee, pur, docu);
            ...
            document.getElementById('submitGenerate').addEventListener('click', function() {
                ...
                document.getElementById('generateDoc').dispatchEvent(new Event('submit'));

            });

            document.getElementById('generateClearance').addEventListener('submit', function(event) {
                event.preventDefault();
                ...
                const recordz = formData.get('recordz');
                const datetodz = setCurrentDate();
                const orno = generateRandomNumber();
                const ctrl = '24-TBYAP-'+generateRandomNumber();
                formData.append('requestCode', reqIdValue);
                formData.append('requestDocu', docu);
                formData.append('cedula', cedula);
                formData.append('record', recordz);
                formData.append('orno', orno);
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        generateExcel(data.newFileName, ctrl, datetodz, requestee, pur, docu, cedula, recordz, orno);
            ...
            document.getElementById('submitClearance').addEventListener('click', function() {

                document.getElementById('generateClearance').dispatchEvent(new Event('submit'));
        ...
        async function generateExcel(fileName, ctrl, datetodz, user, pur, docu, cedula, recordz, orno) {

            const formData = new FormData();

            formData.append('fileName', fileName);
            formData.append('ctrl', '24-TBYAP-'+generateRandomNumber());
            formData.append('datetodz', datetodz);
            formData.append('user_id', user);
            formData.append('purpose', pur);
            formData.append('docu', docu);
            formData.append('cedula', cedula);
            formData.append('record', recordz);
            formData.append('orno', orno);
