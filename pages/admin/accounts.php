...
<head>
    ...
    <title>Blaze Learning | Account</title>
                            ...
                            <div class="user-profile">
                                <div class="widget-content widget-content-area">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#changePass">Change Password</button>
                                    </div>
                                        ...
                                        <div class="col-7">
                                            <ul class="contacts-block list-unstyled">
                                                <li class="contacts-block__item mt-2">
                                                    ...
                                                    <input type="text" class="form-control" name="a" id="a" value="<?php echo $userFirstname." ".$userLastname ?>" readonly>
                                                </li>
                                                <li class="contacts-block__item mt-2">
                                                    <label for="firstname"><p>Role</p></label>
                                                    <input type="text" class="form-control" name="b" id="b" value="Administrator" readonly>
                                                </li>
                                                <li class="contacts-block__item mt-2">
                                                    <label for="firstname"><p>Phone</p></label>
                                                    <input type="text" class="form-control" name="c" id="c" value="<?php echo $userPhone ?>" readonly>
                                                </li>
                                            </ul>
                                        </div>                                    
                                    </div>
