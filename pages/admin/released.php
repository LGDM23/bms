                                                                ...
                                                                <?php
                                                                    ...
                                                                    if ($result && $result->num_rows > 0) {
                                                                        while ($requestee = $result->fetch_assoc()) {
                                                                            ...
                                                                            $html .= '<td class=""><span class=" w-100 bs-tooltip badge '. (($requestee['status'] == 'RELEASED') ? 'badge-success' : 'badge-warning') .' data-bs-toggle="tooltip" data-bs-placement="top" title="Request Released" mb-2 me-4">' . htmlspecialchars($requestee['status']) . '</span></td>';
